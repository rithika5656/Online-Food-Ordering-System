...
<head>
    ...
    <title>Campus Food - Online Food Ordering</title>
...
<body>
    ...
    <!-- Hero Section -->
    <section class="hero">
        <h1>Welcome to Campus Food</h1>
        <p>Order delicious food from your campus canteen - Fast, Easy, Convenient!</p>
    </section>

    <div class="container">
        <!-- Category Filter -->
        <div class="category-filter">
            <button class="category-btn active" data-category="all" onclick="filterMenu('all')">All</button>
